package org.likide.bbgraph.web.application.profile.page;
...
import org.likide.bbgraph.web.application.profile.component.ProfileDescriptionPanel;
import org.likide.bbgraph.web.application.profile.template.ProfileTemplate;
...
public class ProfilePage extends ProfileTemplate {
	...
	protected final IModel<User> userModel = BbgraphSession.get().getUserModel();
