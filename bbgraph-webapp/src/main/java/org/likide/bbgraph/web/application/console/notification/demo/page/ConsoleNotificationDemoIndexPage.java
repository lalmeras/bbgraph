package org.likide.bbgraph.web.application.console.notification.demo.page;
...
import org.likide.bbgraph.core.business.notification.service.INotificationService;
import org.likide.bbgraph.core.business.user.model.User;
import org.likide.bbgraph.web.application.BbgraphSession;
import org.likide.bbgraph.web.application.console.notification.demo.template.ConsoleNotificationDemoTemplate;
import org.likide.bbgraph.web.application.console.notification.demo.util.NotificationDemoEntry;
...
public class ConsoleNotificationDemoIndexPage extends ConsoleNotificationDemoTemplate {
	...
	public ConsoleNotificationDemoIndexPage(PageParameters parameters) {
		...
		add(new Link<Void>("sendExample") {
			...
			public void onClick() {
				try {
					notificationService.sendExampleNotification(BbgraphSession.get().getUser());
