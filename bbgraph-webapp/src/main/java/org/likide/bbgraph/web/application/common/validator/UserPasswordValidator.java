package org.likide.bbgraph.web.application.common.validator;
...
public class UserPasswordValidator implements IFormModelValidator {
	...
	public void validate(Form<?> form) {
		...
		if (Boolean.FALSE.equals(propertyService.get(BbgraphCorePropertyIds.SECURITY_PASSWORD_VALIDATOR_ENABLED)) || !StringUtils.hasText(password)) {
			return;
		}
