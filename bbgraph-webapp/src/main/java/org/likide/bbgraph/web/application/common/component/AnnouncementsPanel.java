...
public class AnnouncementsPanel extends Panel {
	...
	protected void onConfigure() {
		...
		Date userLastReadDate = BbgraphSession.get().getUser().getAnnouncementInformation().getLastActionDate();
		...
		if (userLastReadDate == null || userLastReadDate.before(mostRecentPublicationStartDate)) {
			...
			closeModel.setObject(!BbgraphSession.get().getUser().getAnnouncementInformation().isOpen());
		}
	}
