...
import org.likide.bbgraph.core.business.authority.BbgraphAuthorityUtils;
import org.likide.bbgraph.core.business.user.model.UserGroup;
import org.likide.bbgraph.core.util.binding.Bindings;
import org.likide.bbgraph.web.application.administration.form.UserGroupPopup;
import org.likide.bbgraph.web.application.administration.model.RoleDataProvider;
...
public class UserGroupDetailDescriptionPanel extends GenericPanel<UserGroup> {
	...
	@SpringBean
	private BbgraphAuthorityUtils authorityUtils;
